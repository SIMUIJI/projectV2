...
<%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions" %>
    ...
    <!-- 메인영역 시작 -->
    <div id="main" style="margin-left: 550px; margin-bottom: 50px; margin-top: 50px">
        <div class="margin30">
            <i class="fa fa-star fa-2x" style="color: #1c7430">레시피 게시판</i>


        </div> <!-- 타이틀 -->

        <div class="row margin1050">
            <div class="col-9 text-right" style="margin-bottom: 20px; margin-top: 20px;">
    <c:if test="${empty UID}">
        ...
        <div class="row margin1050">
            <div class="col-9">
                <table class="table table-striped"
                    ...
                    <thead style="background: rgba(96,219,84,0.67)">
